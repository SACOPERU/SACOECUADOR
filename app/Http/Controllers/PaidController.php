...
class PaidController extends Controller
{
    ...
    private function generarDocumentoXml(Order $order)
    {
        ...
        if ($order->condicion_pago == 1 || $order->condicion_pago == 2) {
            $codigoPagoValue = ($order->condicion_pago == 1) ? 'IZIPAY-T.DEB' : 'IZIPAY-T.CRE';
    ...
    private function generarDocumentoXmlInyectaCtaCte(Order $order)
    {
        ...
        if ($order->condicion_pago == 1 || $order->condicion_pago == 2) {
            $clienteProveedor->addChild('CondPago', ($order->condicion_pago == 1) ? 'IZIPAY-T.DEB' : 'IZIPAY-T.CRE');
        };
        ...
        $clienteProveedor->addChild('Comentario1', 'VENTA WEB IZYPAY');
