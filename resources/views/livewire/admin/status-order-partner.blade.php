    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mb-6 ">
            ...
            <div class="bg-white rounded-lg shadow-lg px-6 py-8 mb-6 flex items-center">
                <div class="relative">
                    <div
                        class="{{ $order->status >= 2 && $order->status != 6 ? 'bg-blue-400' : ' bg-gray-400 ' }} rounded-full h-12 w-12 flex items-center justify-center">
                ...
                <div class="relative">
                    <div
                        class="rounded-full h-12 w-12 {{ $order->status >= 4 && $order->status != 6 ? 'bg-blue-400' : ' bg-gray-400 ' }} flex items-center justify-center">
                ...
                <div
                    class="h-1 flex-1 {{ $order->status >= 5 && $order->status != 6 ? 'bg-blue-400' : ' bg-gray-400 ' }} mx-2">
                </div>

                <div class="relative">
                    <div
                        class="rounded-full h-12 w-12 {{ $order->status >= 6 && $order->status != 6 ? 'bg-blue-400' : ' bg-gray-400 ' }} flex items-center justify-center">
                        <i class="fas fa-check text-white"></i>
                    </div>
                    <div class="absolute -left-3.5 mt-0.5">
                        <p>Entregado</p>
