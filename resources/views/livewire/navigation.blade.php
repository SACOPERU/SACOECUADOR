...
<header class="bg-gray-100 sticky top-0 z-50 border-b-2 border-blue-500" x-data="dropdown()">
    <div class="container flex items-center h-16 justify-between md:justify-start space-x-8">
        ...
        <a href="/" class="mx-6">
            <img class=" navbar-brand-full app-header-logo" src="{{ asset('img/Nueva carpeta/logo1.png') }}" width="150"
                alt="Infyom Logo">
        </a>
        ...
        <div x-data="{ activeCategory: null, closeTimer: null, isWindowWideEnough: window.innerWidth >= 1300 && window.innerHeight >= 600 }" x-init="() => {
            ...
            <div class="flex app items-center h-10 justify-between md:justify-start space-x-8">
                <a href="https://shop-peru.saco-communications.com/xiaomi">XIAOMI</a>
                <a href="https://shop-peru.saco-communications.com/samsung">SAMSUNG</a>
                <a href="https://shop-peru.saco-communications.com/vivo">VIVO</a>
                <a href="https://shop-peru.saco-communications.com/infinix">INFINIX</a>
            </div>
