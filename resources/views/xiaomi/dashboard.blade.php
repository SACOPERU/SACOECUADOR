    ...
    <x-xiaomi-layout>
        <section class="my-2 container  ">
            ...
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    @foreach ($xcovers as $index => $xcover)
                        @if ($isMobile && Str::contains(strtolower($xcover->name), 'movil'))
                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                <img src="{{ asset('storage/' . $xcover->image) }}"
                                    class="absolute block w-full h-full object-cover" alt="...">
                            </div>
                        @elseif (!$isMobile && Str::contains(strtolower($xcover->name), 'banners'))
                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                <img src="{{ asset('storage/' . $xcover->image) }}"
                                    class="absolute block w-full h-full object-cover" alt="...">
                            </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-6 py-2 bg-gray-100  border border-orange-500"
