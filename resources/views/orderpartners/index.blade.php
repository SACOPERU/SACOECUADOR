<x-partner-layout>
    <div class="container py-6 md:py-12">
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-white">
            ...
            <a href="{{ route('orderpartners.index') . '?status=1' }}"
                class="bg-gray-400 bg-opacity-75 rounded-lg px-8 py-6 md:py-8 text-center">
                <p class="text-2xl">
                    {{ $reservado }}
                </p>
            ...
            <a href="{{ route('orderpartners.index') . '?status=2' }}"
            ...
            <a href="{{ route('orderpartners.index') . '?status=3' }}"
            ...
            <a href="{{ route('orderpartners.index') . '?status=4' }}"
            ...
            <a href="{{ route('orderpartners.index') . '?status=5' }}"
